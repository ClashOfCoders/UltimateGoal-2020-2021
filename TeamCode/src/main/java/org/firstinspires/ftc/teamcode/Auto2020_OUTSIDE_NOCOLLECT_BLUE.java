...
@Autonomous(name= "Blue No Collect Outside")
public class Auto2020_OUTSIDE_NOCOLLECT_BLUE extends LinearOpMode {
    //camera variables
    ...
    public void runOpMode() {
        ...
        Trajectory initialShot = drive.trajectoryBuilder(drive.getPoseEstimate())
                .splineToConstantHeading(new Vector2d(-36, 50), 0.0)
                .splineToSplineHeading(new Pose2d(-6, 56, Math.atan2((36 - 52.0), (74+10))+shootAngleOffsetRadians+Math.toRadians(-4)), 0.0)
                .build();

        Trajectory dumpWobble4 = drive.trajectoryBuilder(initialShot.end())
                .splineToSplineHeading(new Pose2d(46.0,60, Math.toRadians(15.0)), Math.toRadians(0.0))
        ...
        Trajectory dumpWobble0 = drive.trajectoryBuilder(initialShot.end())
                .splineToSplineHeading(new Pose2d(12.0,44.0, Math.toRadians(105.0)), Math.toRadians(0.0))

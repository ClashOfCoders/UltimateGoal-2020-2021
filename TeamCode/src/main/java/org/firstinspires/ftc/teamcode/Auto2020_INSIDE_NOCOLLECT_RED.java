...
@Autonomous(name= "Red No Collect Inside")
public class Auto2020_INSIDE_NOCOLLECT_RED extends LinearOpMode {
    //camera variables
    ...
    public void runOpMode() {
        ...
        Trajectory initialShot = drive.trajectoryBuilder(drive.getPoseEstimate())
                .lineToLinearHeading(new Pose2d(-6.0,-12.0,Math.atan2((-36 + 12), (74 + 6))+shootAngleOffsetRadians+Math.toRadians(2.5)))
                .build();
        ...
        Trajectory park4 = drive.trajectoryBuilder(dumpWobble4.end(), true)
                ...
                .addSpatialMarker(new Vector2d(48.0,-36.0), new MarkerCallback() {
                    @Override
                    public void onMarkerReached() {
                        robot.wobbleServo.setPosition(0.65);
        ...
        Trajectory dumpWobble1 = drive.trajectoryBuilder(initialShot.end())
                .splineToSplineHeading(new Pose2d(29.0, -18.0, Math.toRadians(-60.0)), 0.0)
        ...
        Trajectory dumpWobble0 = drive.trajectoryBuilder(initialShot.end())
                .splineToSplineHeading(new Pose2d(12.0,-44.0, Math.toRadians(-85.0)), Math.toRadians(0.0))

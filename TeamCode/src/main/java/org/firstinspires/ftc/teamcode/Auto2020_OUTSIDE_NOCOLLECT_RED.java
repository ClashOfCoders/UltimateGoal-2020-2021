...
@Autonomous(name= "Red No Collect Outside")
public class Auto2020_OUTSIDE_NOCOLLECT_RED extends LinearOpMode {
    //camera variables
    ...
    public void runOpMode() {
        ...
        Trajectory initialShot = drive.trajectoryBuilder(drive.getPoseEstimate())
                ...
                .splineToSplineHeading(new Pose2d(-6, -56, Math.atan2((-36 + 56.0), (74+6))+shootAngleOffsetRadians+Math.toRadians(3)), 0.0)
                .build();

        Trajectory dumpWobble4 = drive.trajectoryBuilder(initialShot.end())
                .splineToSplineHeading(new Pose2d(46.0,-55, Math.toRadians(0.0)), Math.toRadians(0.0))
